...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        System.out.println("isBlacklisted:"+ inMemoryJwtBlacklist.isBlacklisted(jwt));
        if(inMemoryJwtBlacklist.isBlacklisted(jwt)){
            System.out.println(inMemoryJwtBlacklist.isBlacklisted(jwt));
            filterChain.doFilter(request,response);
            return;
        }
